        ...
        <div class="rounded-2xl border border-zinc-800 bg-zinc-900 px-5 py-4">
          ...
          <div class="flex flex-wrap gap-3">
            <template v-if="ticketResults.length">
              ...
              <div v-else-if="ticketResults.length === 1" class="flex-1 min-w-[80px] rounded-xl bg-zinc-800/60 px-3 py-2.5 text-center">
                <p class="text-lg font-bold text-emerald-400">{{ formatCurrency(ticketResults[0].data.totals.total, ticketResults[0].data.ticket.currency) }}</p>
                <p class="text-[10px] text-zinc-500 font-medium uppercase tracking-wider mt-0.5">Spent</p>
              </div>
